function randombg() {
    ...
    var bigSize = ["radial-gradient(circle at 50% 50%, rgba(0, 0, 0, 0.46), rgba(0, 0, 0, 0.88)), url('https://raw.githubusercontent.com/claraclickman/claraclickman.github.io/master/Images/Kitchen2_1.jpg')",
        ...
        "radial-graient(circle at 50% 50%, rgba(0, 0, 0, 0.46), rgba(0, 0, 0, 0.88)), url('https://raw.githubusercontent.com/claraclickman/claraclickman.github.io/master/Images/cloudcity.png')",
